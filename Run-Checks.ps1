...
$files = @(
    'Parts\Bridge.Core.ps1', 'Parts\Bridge.Telegram.ps1', 'Parts\Bridge.News.ps1', 'Parts\Bridge.Mojaz.ps1', 'Parts\Bridge.Mojaz.Design.ps1', 'Parts\Bridge.Mojaz.Screens.ps1', 'Parts\Bridge.Mojaz.Playback.ps1', 'Parts\Bridge.Urgent.ps1', 'Parts\Bridge.Urgent.Playback.ps1', 'Parts\Bridge.Users.ps1', 'Parts\Bridge.Templates.ps1', 'Parts\Bridge.OnAir.ps1', 'Parts\Bridge.Schedule.ps1', 'Parts\Bridge.Keyboards.ps1', 'Parts\Bridge.ShowFlow.ps1', 'Parts\Bridge.WhatsNew.ps1', 'Parts\Bridge.Help.ps1', 'Parts\Bridge.Help.En.ps1', 'Parts\Bridge.AirOperation.ps1', 'Parts\Bridge.Admin.ps1', 'Parts\Bridge.Admin.Templates.ps1', 'Parts\Bridge.Admin.Health.ps1', 'Parts\Bridge.Admin.Config.ps1', 'Parts\Bridge.Admin.Diagnostics.ps1', 'Parts\Bridge.Media.ps1', 'Parts\Bridge.Commands.ps1', 'Parts\Bridge.Callbacks.ps1', 'Parts\Bridge.Tick.ps1', 'Parts\Bridge.Reports.ps1', 'Parts\Bridge.Announcements.ps1', 'Parts\Bridge.Weekly.ps1', 'Parts\Bridge.Boards.ps1',
    'TelegramBridge.ps1', 'Modules\CinegyAirTitler.psm1', 'Modules\BridgeSecurity.psm1', 'Modules\BridgeSettings.psm1', 'Modules\BridgeStorage.psm1', 'Modules\BridgeTelegram.psm1', 'Modules\BridgeAuthorization.psm1', 'Modules\BridgeFlowState.psm1', 'Modules\BridgeCinegyState.psm1', 'Modules\BridgeSchedulePolicy.psm1', 'Modules\BridgeMedia.psm1', 'Modules\BridgeRelayPolicy.psm1', 'Modules\BridgeRuntimeState.psm1', 'Modules\BridgeNewsTicker.psm1', 'Modules\BridgeMojaz.psm1', 'Modules\BridgeUrgent.psm1', 'Modules\BridgeOperationPolicy.psm1', 'Modules\BridgeOperationLifecycle.psm1', 'Modules\BridgeSettingsSchema.psm1', 'Modules\BridgeUiPaging.psm1', 'Modules\BridgeLiveScenes.psm1', 'Modules\BridgeContentBoards.psm1', 'Modules\BridgeAirText.psm1', 'Modules\BridgeLanguage.psm1', 'Modules\BridgeStreamOutages.psm1',
    'Modules\BridgeText\Common.ps1', 'Modules\BridgeText\Settings.ps1', 'Modules\BridgeText\Screens.ps1', 'Modules\BridgeText\Content.ps1', 'Modules\BridgeText\Alerts.ps1', 'Modules\BridgeText\Replies.ps1', 'Modules\BridgeText\Reports.ps1', 'Modules\BridgeText\Flow.ps1', 'Modules\BridgeText\Admin.ps1', 'Modules\BridgeText\Air.ps1', 'Modules\BridgeText\Keyboards.ps1', 'Modules\BridgeText\AdminTools.ps1', 'Modules\BridgeText\Screens2.ps1', 'Modules\BridgeText\Interp1.ps1', 'Modules\BridgeText\Interp2.ps1', 'Modules\BridgeText\Interp3.ps1', 'Modules\BridgeText\Interp4.ps1', 'Modules\BridgeText\Interp5.ps1', 'Modules\BridgeText\Interp6.ps1', 'Modules\BridgeText\Interp7.ps1', 'Modules\BridgeText\Interp8.ps1', 'Modules\BridgeText\Interp9.ps1', 'Modules\BridgeText\Core.ps1', 'Modules\BridgeText\Help.ps1', 'Modules\BridgeText\WhatsNew.ps1', 'Modules\BridgeText\Feed.ps1', 'Modules\BridgeText\Feed.ps1',
...
foreach ($pair in @(
        ...
        # The catalogue's domain files. Without this a deleted one would
        # take its half of the bot's text with it and pass the gate.
        @{ Folder = 'Modules\BridgeText'; Filter = '*.ps1' })) {
...
$powerShellFiles = @(
    'TelegramBridge.ps1', 'Modules\CinegyAirTitler.psm1', 'Modules\BridgeSecurity.psm1', 'Modules\BridgeSettings.psm1', 'Modules\BridgeStorage.psm1', 'Modules\BridgeTelegram.psm1', 'Modules\BridgeAuthorization.psm1', 'Modules\BridgeFlowState.psm1', 'Modules\BridgeCinegyState.psm1', 'Modules\BridgeSchedulePolicy.psm1', 'Modules\BridgeMedia.psm1', 'Modules\BridgeRelayPolicy.psm1', 'Modules\BridgeRuntimeState.psm1', 'Modules\BridgeNewsTicker.psm1', 'Modules\BridgeMojaz.psm1', 'Modules\BridgeUrgent.psm1', 'Modules\BridgeOperationPolicy.psm1', 'Modules\BridgeOperationLifecycle.psm1', 'Modules\BridgeSettingsSchema.psm1', 'Modules\BridgeUiPaging.psm1', 'Modules\BridgeLiveScenes.psm1', 'Modules\BridgeContentBoards.psm1', 'Modules\BridgeAirText.psm1',
    'scripts\Install-BridgeTask.ps1', 'scripts\Uninstall-BridgeTask.ps1',
    'scripts\Install-BridgeService-NSSM.ps1', 'scripts\Uninstall-BridgeService-NSSM.ps1',
...
$parseTargets = @($powerShellFiles) + @(
    foreach ($folder in @('Parts', 'Tests', 'Modules\BridgeText')) {
