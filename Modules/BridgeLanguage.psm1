...
foreach ($textFile in @('Common', 'Settings', 'Screens', 'Content', 'Alerts', 'Replies', 'Reports', 'Flow', 'Admin', 'Air', 'Keyboards', 'AdminTools', 'Screens2', 'Interp1', 'Interp2', 'Interp3', 'Interp4', 'Interp5', 'Interp6', 'Interp7', 'Interp8', 'Interp9', 'Core')) {
...
function New-BridgeTextCatalogue {
    ...
    foreach ($section in @('Common', 'Settings', 'Screens', 'Content', 'Alerts', 'Replies', 'Reports', 'Flow', 'Admin', 'Air', 'Keyboards', 'AdminTools', 'Screens2', 'Interp1', 'Interp2', 'Interp3', 'Interp4', 'Interp5', 'Interp6', 'Interp7', 'Interp8', 'Interp9', 'Core')) {
