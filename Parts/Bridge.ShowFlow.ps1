...
function Get-WhatsNewSections {
    ...
    return @(
        @{ Version = '5.7.4'; Items = @(
                '⚠️ مراقب المخرج ينبه الآن إذا تعذّر التقاط المصدر أكثر من مرة، لا للشاشة السوداء فقط.'
                '🔁 عند تعذّر المصدر الأساسي يتحول تلقائيًا إلى مصدر Cinegy الاحتياطي، ثم يعود إليه عند التعافي.'
