...
foreach ($textFile in @('Common', 'Settings', 'Screens', 'Content', 'Alerts', 'Replies', 'Reports', 'Flow', 'Admin')) {
...
function New-BridgeTextCatalogue {
    ...
    foreach ($section in @('Common', 'Settings', 'Screens', 'Content', 'Alerts', 'Replies', 'Reports', 'Flow', 'Admin')) {
