...
$files = @(
    'TelegramBridge.ps1', 'Modules\CinegyAirTitler.psm1', 'Modules\BridgeSecurity.psm1', 'Modules\BridgeSettings.psm1', 'Modules\BridgeStorage.psm1', 'Modules\BridgeTelegram.psm1', 'Modules\BridgeAuthorization.psm1',
    ...
    'Tests\Bridge.Tests.ps1', 'Tests\BridgeSettings.Tests.ps1', 'Tests\BridgeStorage.Tests.ps1', 'Tests\BridgeTelegram.Tests.ps1', 'Tests\BridgeAuthorization.Tests.ps1', 'Tests\Smoke-OnAir.Tests.ps1', 'Tests\Release.Tests.ps1', 'Tests\Security.Tests.ps1',
