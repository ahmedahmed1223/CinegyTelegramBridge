...
- **ترتيب أعمدة الجداول صار عربيًّا.** تيليجرام يرصف خلايا الصف من اليسار إلى اليمين مهما كان اتجاه الرسالة، فالعمود المكتوب أولًا كان يقع في أقصى اليسار — **حيث تصل عين القارئ العربي أخيرًا**. فكان العمود المُعرِّف آخر ما يُقرأ، والأقلّ أهمية أوّله. الصف صار يُقلَب في البنّاء المركزي وحده، والمستدعون يواصلون كتابة الأهمّ أولًا.
- **شاشة الحالة**: المشغّل في أقصى اليمين، ثم القالب، ثم «منذ»، ورقم الطبقة في أقصى اليسار — وهو أقلّ ما يعني قارئًا في بنر حيّ.
- اختبارات الجداول صارت تقرأ الخلية **باسم عمودها** لا بموضعها: التأكيدات الموضعية انكسرت مرتين في هذا الإصدار — بالعزل ثم بالقلب — وكانت ستنكسر مع كل إعادة ترتيب لاحقة.

## 7.14.0 — 2026-08-31

- **يصلح اتجاه خلايا الجداول.** كل جداول هذه الشاشات عربية وفيها خلايا لاتينية ورقمية — مفتاح قالب، `12–18`، `07:10 ← 21:40`، `ط7`. داخل رسالة من اليمين إلى اليسار تأخذ الأرقام والمحايدات بينها (الشرطة، السهم، النقطتان، النقطة الوسطى) اتجاهها ممّا يحيط بها، فيُعرض `07:10 ← 21:40` بطرفيه معكوسين و`12–18` كأنه `18–12`. **العطل نفسه الذي عكس الأقواس في سطر التدقيق في `6.9.1`، بعمود واحد.**
- **كل خلية صارت معزولة** بـ`FSI…PDI` لا بعلامة LRM كما في سطر التدقيق: الخلية لا اتجاه ثابت لها يُثبَّت إليه، وعازل «أول حرف قويّ» يدع كلًّا منها تقرّر لنفسها ويمنعها من إعادة ترتيب جاراتها.
- **`New-BridgeTableBlock` صار المكان الوحيد الذي يُبنى فيه جدول** — الجداول الخمسة تمرّ به، فلا تختلف في العزل ولا في الحدود ولا في التخطيط.
- **الحالة الكاملة صارت أقسامًا مسمّاة** بدل طيّة واحدة طويلة: اتصال Cinegy · صحة الخدمات · التشغيل والجدولة · الوصول. مَن يلاحق موضوعًا منها لا يفتح الثلاثة الأخرى ليصل إليه.
- الخلية الفارغة تبقى فارغة ولا تُملأ بعلامات غير مرئية، وخلايا المستدعي لا تُمسّ — تُبنى نسخة، لأن الشاشة تُرسَم من جديد عند كل تحديث.
