...
foreach ($textFile in @('Common', 'Settings', 'Screens', 'Content', 'Alerts', 'Replies', 'Reports', 'Flow', 'Admin', 'Air', 'Keyboards', 'AdminTools', 'Screens2', 'Interp1', 'Interp2', 'Interp3', 'Interp4')) {
...
function New-BridgeTextCatalogue {
    ...
    foreach ($section in @('Common', 'Settings', 'Screens', 'Content', 'Alerts', 'Replies', 'Reports', 'Flow', 'Admin', 'Air', 'Keyboards', 'AdminTools', 'Screens2', 'Interp1', 'Interp2', 'Interp3', 'Interp4')) {
