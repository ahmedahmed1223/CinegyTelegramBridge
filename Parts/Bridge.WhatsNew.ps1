...
function Get-WhatsNewSections {
    ...
    return @(
        @{ Version = '8.42.0'; Items = @(
                '⏱ للمشرف: الإعدادات ← القوالب ← أقصى مدة لكل قالب. اختر قالبًا وحدّد 1–3600 ثانية بالأزرار؛ يبدأ الإخفاء مع عرضه ولا يستطيع المشغّل تمديده فوق الحد. إزالة القاعدة تحتاج تأكيدًا.'
