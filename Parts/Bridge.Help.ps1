...
function Get-HelpChapters {
    ...
    $chapters = @(
        ...
        @{ Key = 'boards'; Title = '🗂 محتوى البرامج'; AdminOnly = $false; Available = (Test-BoardsAvailable); Body = @(
                ...
                ''
                '🆕 جدول جديد (للمشرف): اختر القالب ثم سمِّ الجدول.'
                '↳ الحقول تأتي من المشهد نفسه، لا تُكتب ولا تُخترع.'
                '↳ قالبٌ لا يعلن حقلًا نصّيًا يظهر ممتنعًا ومعه سببه.'
                ''
                ...
                ''
                '🛡 من يملأ الجدول (للمشرف): الجميع / المشرفون / المالك.'
