...
$files = @(
    ...
    'Modules\BridgeText\Common.ps1', 'Modules\BridgeText\Settings.ps1', 'Modules\BridgeText\Screens.ps1', 'Modules\BridgeText\Content.ps1', 'Modules\BridgeText\Alerts.ps1', 'Modules\BridgeText\Replies.ps1', 'Modules\BridgeText\Reports.ps1', 'Modules\BridgeText\Flow.ps1', 'Modules\BridgeText\Admin.ps1', 'Modules\BridgeText\Air.ps1',
